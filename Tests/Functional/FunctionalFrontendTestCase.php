...
class FunctionalFrontendTestCase extends \TYPO3\TestingFramework\Core\Functional\FunctionalTestCase
{
     ...
     */
    protected function setupFrontendController(int $pageUid = 223): void
    {
